package com.xalik.test.repository;

import com.xalik.test.TestApp;
import com.xalik.test.config.Constants;
import com.xalik.test.config.TestSecurityConfiguration;
import com.xalik.test.config.audit.AuditEventConverter;
import com.xalik.test.domain.PersistentAuditEvent;
...
import static com.xalik.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
